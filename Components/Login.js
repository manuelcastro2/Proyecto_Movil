        ...
        <BlurView intensity={100}>
          <View style={styles.login}>
            ...
            <View>
              ...
              <TextInput onChangeText={(text) => setEmail(text)} style={styles.input} placeholder="jarley231034@gmail.com"/>
            </View>
            <View>
